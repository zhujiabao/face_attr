...
def args():
    parser = ArgumentParser(description="Train the model_xioayin of face attrbute recongition")
    ...
    parser.add_argument("--pretrained", type=bool, default=True, help="false means don't load pretrain model_xioayin, True means load")
    parser.add_argument("--model_file", type=str, default="model_xioayin/resnet50-19c8e357.pth", help="load the pretrain model_xioayin")
